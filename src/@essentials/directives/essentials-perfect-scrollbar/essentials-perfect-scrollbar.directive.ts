...
import { EssentialsPerfectScrollbarGeometry, EssentialsPerfectScrollbarPosition } from '@essentials/directives/essentials-perfect-scrollbar/essentials-perfect-scrollbar.interfaces';
import { EssentialsConfigService } from '@essentials/services/config.service';

@Directive({
    selector: '[essentialsPerfectScrollbar]'
})
export class EssentialsPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set essentialsPerfectScrollbarOptions(value)
    {
        // Merge the options
    ...
    get essentialsPerfectScrollbarOptions(): any
    {
        // Return the options
     ...
     * @param {boolean | ""} value
     */
    @Input('essentialsPerfectScrollbar')
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.essentialsPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.essentialsPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): EssentialsPerfectScrollbarGeometry
    {
        return new EssentialsPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): EssentialsPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new EssentialsPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
