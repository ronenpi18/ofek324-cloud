...
export class EssentialsInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {EssentialsMatchMediaService} _essentialsMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _essentialsMediaMatchService: EssentialsMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._essentialsMediaMatchService.onMediaChange
