...
export class EssentialsNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._essentialsNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._essentialsNavigationService.onItemCollapsed.next(this.item);
        this._essentialsNavigationService.onItemCollapseToggled.next();
    }
