...
@Component({
    selector       : 'essentials-navigation',
    templateUrl    : './navigation.component.html',
    styleUrls      : ['./navigation.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class EssentialsNavigationComponent implements OnInit
{
    @Input()
    layout = 'vertical';
    ...
    ngOnInit(): void
    {
        ...
        this.navigation = this.navigation || this._essentialsNavigationService.getCurrentNavigation();
