...
@Component({
    selector     : 'essentials-widget',
    templateUrl  : './widget.component.html',
    styleUrls    : ['./widget.component.scss'],
    encapsulation: ViewEncapsulation.None
})

export class EssentialsWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(EssentialsWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<EssentialsWidgetToggleDirective>;
