...
import { EssentialsSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'essentials-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class EssentialsSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._essentialsConfigService.config
            ...
            .subscribe((config) => {
                this._essentialsConfig = config;
            });

        // Register the sidebar
        this._essentialsSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._essentialsSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('essentials-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('essentials-sidebar-overlay-invisible');
        }
