...
import '@essentials/components/highlight/prism-languages';

@Component({
    selector : 'essentials-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class EssentialsHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using essentials-highlight
        // component
